...
//    private OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int questionNum = SubjectOverviewActivity.getNumQuestion();
        String subject = SubjectOverviewActivity.getSubject();
        setStatic(rootView, questionNum, subject);

        Button button = (Button) rootView.findViewById(R.id.begin);
    ...
    private void setStatic(View rootView, int questionNum, String subjectName) {
        TextView number = (TextView) rootView.findViewById(R.id.questionNum);
        number.setText("" + number.getText() + questionNum);

        // add the extra data into the text view of the 2nd activity (this layout)
        TextView subjectTitle = (TextView) rootView.findViewById(R.id.subjectChosen);
